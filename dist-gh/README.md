...
- **本站（镜像）**：<https://lp000-l.github.io/docbase-site/>
- **当前版本**：`1.7.2`（2026 年 9 月 23 日 更新）

## 这是什么

文渊阁是一个 Windows 单机知识库软件：文档 / 表格 / PPT / PDF / 图片统一管理，可预览编辑、
可直接运行代码（Python / JavaScript / SQL 等）、支持 .ipynb 笔记本，并能导出多种格式。
详见正式站点的[功能说明](https://lp000-l.github.io/docbase-site/#volume)。
...
| 版本 | 说明 | 文件 |
|---|---|---|
| 安装版 `1.7.2` | 双击安装，自动更新 | [Releases](https://github.com/lp000-l/docbase-site/releases/latest) · `DocBase-Setup-1.7.2.exe` |
| 便携版 `1.7.2` | 解压即用 · 自带 Python · 资料跟着 U 盘走 | [Releases](https://github.com/lp000-l/docbase-site/releases/latest) · `DocBase-Portable-1.7.2.zip` |

- 安装版会自动检查更新（读正式站点的 `updates.json`）。
- 便携版**不参与自动更新**，升级请换一个新的便携包。
- 校验码（SHA-256）在正式站点的下载区与[便携版专页](https://lp000-l.github.io/docbase-site/portable.html)都有列出。
