...
| 版本 | 说明 | 文件 |
|---|---|---|
| **安装版 `1.7.4`** | 双击安装，自动检查更新 | [Releases](https://github.com/lp000-l/docbase-site/releases/latest) · `DocBase-Setup-1.7.4.exe` |
| **便携版 `1.7.4`** | 解压即用 · 自带 Python · 资料跟着 U 盘走 | [Releases](https://github.com/lp000-l/docbase-site/releases/latest) · `DocBase-Portable-1.7.4.zip` |
...
- 正式站点永远以 <https://bishe.xin/> 为准。当前镜像版本：`1.7.4`（2026 年 9 月 24 日 更新）。
